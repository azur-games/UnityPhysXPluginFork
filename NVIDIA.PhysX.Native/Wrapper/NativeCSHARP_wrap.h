...
public:
    ...
    typedef void (SWIGSTDCALL* SWIG_Callback0_t)(void *, unsigned int, unsigned int, unsigned int,  physx::PxFilterData* , unsigned int,  physx::PxFilterData* );
...
public:
    ...
    typedef void (SWIGSTDCALL* SWIG_Callback0_t)(void*, int, char *, char *, int);
