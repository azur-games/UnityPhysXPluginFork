...
public partial class PxErrorCallback {
  ...
  [MonoPInvokeCallback(typeof(SwigDelegatePxErrorCallback_0))]
  static private void SwigDirectorMethodreportError(global::System.IntPtr instPtr, int code, string message, string file, int line) {
    var ms = GCHandle.FromIntPtr(instPtr).Target as PxErrorCallback;
    ms.reportError((PxErrorCode)code, message, file, line);
  }
  [UnmanagedFunctionPointer(CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
  public delegate void SwigDelegatePxErrorCallback_0(global::System.IntPtr instPtr, int code, string message, string file, int line);
